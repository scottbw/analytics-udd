...
### Purpose
Enables an institution to record the number of attempts a student has made, including the current attempt, that are officially recognised by the institution as attempts at the assessment. See Notes. ASSESSMENT_CURRENT_ATTEMPT differs from ASSESS_SEQ_ID, which identifies all assessment opportunities, whether actually taken or not, and regardless of mitigating circumstances.
