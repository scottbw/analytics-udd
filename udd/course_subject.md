...
### Notes
If a course is associated with multiple subject codes, the same subject coding scheme must be used for all codes. Typically this will be either JACS3 or, in the future, HECoS. 
...
## PROPORTION
### Description
This property shows the weighting of the subject of study as a percentage of the study load. For a balanced combined course, this value will be 50.
...
### Notes
Typically used where it is necessary to use more than 1 subject of study to describe a course adequately.
